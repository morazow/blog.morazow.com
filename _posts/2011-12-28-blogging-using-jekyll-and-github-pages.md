...
In order to setup all, I have followed the [David Winter's Post](https://davidwinter.me/setting-up-github-pages/)
...
You should now be able to see the generated site locally by visiting `http://localhost:4000`.
